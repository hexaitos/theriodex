...
GET_POKEMON_BY_MOVE_Q = DB.prepare(GET_POKEMON_BY_MOVE_QSTR)

def get_pokemon_by_move(move_id, generation_id, language_id = 9)
	rs = GET_POKEMON_BY_MOVE_Q.execute([ language_id, language_id, language_id, language_id, language_id, language_id, generation_id, move_id ])
