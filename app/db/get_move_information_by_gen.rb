...
SELECT DISTINCT
    pokemonmove.move_id,
    name.name,
    COALESCE(move_change.type_id, move.type_id) AS move_type_id,
    typename.name AS move_type_name,
    movedmgname.name AS move_damage_name,
    move.move_damage_class_id,
    COALESCE(move_change.power, move.power) AS move_power,
    COALESCE(move_change.accuracy, move.accuracy) AS move_accuracy,
    COALESCE(move_change.pp, move.pp) AS PP,
    ...
    COALESCE(move_change.move_effect_chance, move_effect.effect) AS move_effect_text,
    ...
    move_change.type_id AS type_id_old,
    move_change.power AS power_old,
    move_change.accuracy AS accuracy_old,
    move_change.pp AS PP_old,
    move_change.move_effect_chance AS effect_chance_old
FROM (
